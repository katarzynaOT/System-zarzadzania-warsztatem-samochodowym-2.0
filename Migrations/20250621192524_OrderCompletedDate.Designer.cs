...
namespace WorkshopManager.Data.Migrations
{
    ...
    [Migration("20250621192524_OrderCompletedDate")]
    partial class OrderCompletedDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkshopManager.Models.Comment", b =>
                {
                    b.HasOne("WorkshopManager.Models.ServiceOrder", "Order")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("WorkshopManager.Models.ServiceOrder", b =>
                {
                    b.HasOne("WorkshopManager.Models.Car", "Car")
                        .WithMany("Orders")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
